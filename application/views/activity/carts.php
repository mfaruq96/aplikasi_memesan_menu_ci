						...
						<table class="table table-hover text-nowrap text-center" id="dataTable" cellspacing="0" cellpadding="0">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="<?= base_url('activity/carts_edit/') . $order_detail['id_order_detail']; ?>" class="badge badge-primary"><i class="fas fa-edit"></i> edit</a>
										<a href="<?= base_url('activity/carts_delete/') . $order_detail['id_order_detail']; ?>" class="badge badge-danger" onclick="return confirm('Are you sure want to delete ?');"><i class="fas fa-trash"></i> delete</a>
									</td>
								</tr>
								<?php endforeach; ?>
								<tr>
