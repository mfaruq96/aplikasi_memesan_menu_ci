			...
			<div class="col-md-8">
				...
				<table class="table">
					<tbody>
						...
						<form action="<?= base_url('activity/add/') . $product['id_product']; ?>" method="post">
							<tr>
								<td>Qty</td>
								<td>:</td>
								<td>
							...
							<tr>
								...
								<td>:</td>
								<td>
									<textarea name="note" id="note" rows="2" class="form-control" maxlength="100"></textarea>
								</td>
							</tr>
							<tr>
								<td colspan="3" class="text-right">
									<button type="submit" class="btn btn-primary mt-3"><i class="fa fa-shopping-cart mr-3"></i>ADD TO CART</button>
								</td>
							</tr>
						</form>
					</tbody>
